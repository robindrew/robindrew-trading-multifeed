...
public class IgIndexConnectionManager implements IIgIndexConnectionManager, IgIndexConnectionManagerMBean {

	private static final Logger log = LoggerFactory.getLogger(IgIndexConnectionManager.class);
	...
	public IgIndexConnectionManager(IIgIndexRestService rest, IIgIndexTradingPlatform platform) {
